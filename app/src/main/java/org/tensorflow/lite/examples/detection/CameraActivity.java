...
public class CameraActivity extends AppCompatActivity
  ...
  private boolean processImageAction = true;
  ...
  public void onImageAvailable(final ImageReader reader) {
    ...
    try {
      ...
      if(processImageAction == true){
        //Toast.makeText(this, "Starting detection", Toast.LENGTH_SHORT).show();
        processImage();
  ...
  public void processImageFUNC(View v){
    Toast.makeText(this, "Changed State", Toast.LENGTH_SHORT).show();
  ...
  protected void processImage() {
    //Toast.makeText(CameraActivity.this, "Starting to process Image", Toast.LENGTH_SHORT).show();
    ++timestamp;
